...
# 41 "/usr/include/x86_64-linux-gnu/sys/msg.h" 3 4
...
# 2 "pthread_lock_twothread.c" 2



# 4 "pthread_lock_twothread.c"
typedef struct{
 int num;
...
void* threadFunc(void *p)
{
 ...
 return 
# 13 "pthread_lock_twothread.c" 3 4
       ((void *)0)
# 13 "pthread_lock_twothread.c"
           ;
}
...
int main()
{
 ...
 Data threadInfo;
 threadInfo.num=0;
 ret=pthread_mutex_init(&threadInfo.mutex,
# 22 "pthread_lock_twothread.c" 3 4
                                         ((void *)0)
# 22 "pthread_lock_twothread.c"
                                             );
 
# 23 "pthread_lock_twothread.c" 3 4
{if(
# 23 "pthread_lock_twothread.c"
ret
# 23 "pthread_lock_twothread.c" 3 4
!=0) {printf("%s:%s\n",
# 23 "pthread_lock_twothread.c"
...
# 23 "pthread_lock_twothread.c"
 ...
 gettimeofday(&start,
# 25 "pthread_lock_twothread.c" 3 4
                    ((void *)0)
# 25 "pthread_lock_twothread.c"
                        );
 ret=pthread_create(&pthID,
# 26 "pthread_lock_twothread.c" 3 4
                          ((void *)0)
# 26 "pthread_lock_twothread.c"
 ...
 pthread_join(pthID,
# 34 "pthread_lock_twothread.c" 3 4
                   ((void *)0)
# 34 "pthread_lock_twothread.c"
                       );
 gettimeofday(&end,
# 35 "pthread_lock_twothread.c" 3 4
                  ((void *)0)
# 35 "pthread_lock_twothread.c"
                      );
 ret=pthread_mutex_destroy(&threadInfo.mutex);
 
# 37 "pthread_lock_twothread.c" 3 4
{if(
# 37 "pthread_lock_twothread.c"
ret
# 37 "pthread_lock_twothread.c" 3 4
!=0) {printf("%s:%s\n",
# 37 "pthread_lock_twothread.c"
